...
Agent-I treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

Agent-I “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Agent-I can see that group and respond there.
...
Translation: allowlisted senders can trigger Agent-I by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@Agent-I", "Agent-I", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
