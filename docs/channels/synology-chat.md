---
summary: "Synology Chat webhook setup and Agent-I config"
read_when:
  - Setting up Synology Chat with Agent-I
...
```bash
Agent-I plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your Agent-I gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in Agent-I.
...
- Pairing approvals work with:
  - `Agent-I pairing list synology-chat`
  - `Agent-I pairing approve synology-chat <CODE>`
...
```bash
Agent-I message send --channel synology-chat --target 123456 --text "Hello from Agent-I"
Agent-I message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
