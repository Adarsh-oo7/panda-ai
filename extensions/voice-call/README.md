...
Official Voice Call plugin for **Agent-I**.
...
Docs: `https://docs.Agent-I.ai/plugins/voice-call`
Plugin system: `https://docs.Agent-I.ai/plugin`

## Install (local dev)

### Option A: install via Agent-I (recommended)
...
```bash
mkdir -p ~/.Agent-I/extensions
cp -R extensions/voice-call ~/.Agent-I/extensions/voice-call
cd ~/.Agent-I/extensions/voice-call && pnpm install
```
...
```bash
Agent-I voicecall call --to "+15555550123" --message "Hello from Agent-I"
Agent-I voicecall continue --call-id <id> --message "Any questions?"
Agent-I voicecall speak --call-id <id> --message "One moment"
Agent-I voicecall end --call-id <id>
Agent-I voicecall status --call-id <id>
Agent-I voicecall tail
