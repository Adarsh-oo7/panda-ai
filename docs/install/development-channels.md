...
Agent-I ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Agent-I also aligns
the install method:
...
When you switch channels with `Agent-I update`, Agent-I also syncs plugin sources:
