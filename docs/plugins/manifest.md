...
read_when:
  - You are building a Agent-I plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (Agent-I.plugin.json)

Every plugin **must** ship a `Agent-I.plugin.json` file in the **plugin root**.
Agent-I uses this manifest to validate configuration **without executing plugin
