...
Agent-I system heartbeat last
Agent-I logs --follow
Agent-I config get agents.defaults.heartbeat
Agent-I channels status --probe
```
...
```bash
Agent-I config get agents.defaults.heartbeat.activeHours
Agent-I config get agents.defaults.heartbeat.activeHours.timezone
Agent-I config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
Agent-I cron list
Agent-I logs --follow
```
