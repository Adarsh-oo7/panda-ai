---
summary: "Use Synthetic's Anthropic-compatible API in Agent-I"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Agent-I registers it as the
...
Note: Agent-I's Anthropic client appends `/v1` to the base URL, so use
