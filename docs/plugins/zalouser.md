...
read_when:
  - You want Zalo Personal (unofficial) support in Agent-I
...
Zalo Personal support for Agent-I via a plugin, using native `zca-js` to automate a normal Zalo user account.
