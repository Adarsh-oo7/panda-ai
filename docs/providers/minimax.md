---
summary: "Use MiniMax M2.5 in Agent-I"
read_when:
  - You want MiniMax models in Agent-I
...
- **Compatibility:** Agent-I still accepts legacy `MiniMax-M2.5-Lightning` configs, but prefer
...
```bash
Agent-I plugins enable minimax-portal-auth  # skip if already loaded.
Agent-I gateway restart  # restart if gateway is already running
Agent-I onboard --auth-choice minimax-portal
```
...
See [MiniMax OAuth plugin README](https://github.com/Agent-I/Agent-I/tree/main/extensions/minimax-portal-auth) for details.
...
Configure manually via `Agent-I.json`:
...
- Use `Agent-I models list` and `Agent-I models set minimax/MiniMax-M2.5` to switch.
...
- Running `Agent-I configure` and selecting **MiniMax M2.5**, or
