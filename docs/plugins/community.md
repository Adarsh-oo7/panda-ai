...
read_when:
  - You want to publish a third-party Agent-I plugin
...
This page tracks high-quality **community-maintained plugins** for Agent-I.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `Agent-I plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `Agent-I plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect Agent-I to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/Agent-I-wechat`
  repo: `https://github.com/icesword0760/Agent-I-wechat`
  install: `Agent-I plugins install @icesword760/Agent-I-wechat`
