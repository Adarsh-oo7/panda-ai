---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Agent-I"
read_when:
  - You want Xiaomi MiMo models in Agent-I
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Agent-I uses
