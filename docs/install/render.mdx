...
Deploy Agent-I on Render using Infrastructure as Code. The included `render.yaml` Blueprint defines your entire stack declaratively, service, disk, environment variables, so you can deploy with a single click and version your infrastructure alongside your code.
...
[Deploy to Render](https://render.com/deploy?repo=https://github.com/Agent-I/Agent-I)
...
repository configures everything needed to run Agent-I:
...
services:
  - type: web
    ...
    envVars:
      ...
      - key: Agent-I_STATE_DIR
        value: /data/.Agent-I
      - key: Agent-I_WORKSPACE_DIR
        value: /data/workspace
      - key: Agent-I_GATEWAY_TOKEN
...
The web dashboard is available at `https://<your-service>.onrender.com/Agent-I`.
...
If you use the original Agent-I repository, Render will not auto-deploy your Agent-I. To update it, run a manual Blueprint sync from the dashboard.
...
For Agent-I, vertical scaling is usually sufficient. Horizontal scaling requires sticky sessions or external state management.
...
This downloads a portable backup you can restore on any Agent-I host.
