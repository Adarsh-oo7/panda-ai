...
- Install via CLI: `Agent-I plugins install @Agent-I/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `Agent-I plugins install ./extensions/zalo`
   - From npm (if published): `Agent-I plugins install @Agent-I/zalo`
...
- Approve via:
  - `Agent-I pairing list zalo`
  - `Agent-I pairing approve zalo <CODE>`
...
- Example: `Agent-I message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `Agent-I channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `Agent-I logs --follow`
