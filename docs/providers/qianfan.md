---
summary: "Use Qianfan's unified API to access many models in Agent-I"
read_when:
...
3. Agent-I installed on your system
...
4. Copy the API key for use with Agent-I

## CLI setup

```bash
Agent-I onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Agent-I Configuration](/gateway/configuration)
