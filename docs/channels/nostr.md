...
read_when:
  - You want Agent-I to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Agent-I to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`Agent-I onboard`) and `Agent-I channels add` list optional channel plugins.
...
```bash
Agent-I plugins install @Agent-I/nostr
```

Use a local checkout (dev workflows):

```bash
Agent-I plugins install --link <path-to-Agent-I>/extensions/nostr
```
  ...
  "channels": {
    "nostr": {
      ...
      "profile": {
        ...
        "nip05": "Agent-I@example.com",
        "lud16": "Agent-I@example.com"
      }
    }
  }
}
