...
```bash
Agent-I plugins install @Agent-I/nextcloud-talk
```

Local checkout (when running from a git repo):

```bash
Agent-I plugins install ./extensions/nextcloud-talk
```
...
2. On your Nextcloud server, create a bot:
   ...
   ```bash
   ./occ talk:bot:install "Agent-I" "<shared-secret>" "<webhook-url>" --feature reaction
   ```
...
- Approve via:
  - `Agent-I pairing list nextcloud-talk`
  - `Agent-I pairing approve nextcloud-talk <CODE>`
