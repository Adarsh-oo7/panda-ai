...
Deepgram is a speech-to-text API. In Agent-I it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Agent-I uploads the audio file to Deepgram and injects the transcript
