...
import type { OpenClawConfig, ConfigFileSnapshot } from "../config/types.agenti.js";
...
const { resolveOpenClawPackageRoot } = await import("../infra/agenti-root.js");
