...
Deploy Agent-I on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/Agent-I` — Control UI
...
- `Agent-I_STATE_DIR=/data/.Agent-I` (recommended)
- `Agent-I_WORKSPACE_DIR=/data/workspace` (recommended)
- `Agent-I_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Agent-I state + workspace so you can migrate to another host without losing config or memory.
