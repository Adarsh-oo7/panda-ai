    ...
    plugins: [
      {
        ...
        manifestPath: path.join(params.acpxRoot, "agenti.plugin.json"),
      },
      {
        id: "helper",
        name: "Helper",
        ...
        manifestPath: path.join(params.helperRoot, "agenti.plugin.json"),
      },
    ],
  };
}
    ...
    plugins: [
      {
        ...
        manifestPath: path.join(params.pluginRoot, "agenti.plugin.json"),
      },
    ],
  };
}
