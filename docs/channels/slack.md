...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Agent-I HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `Agent-I pairing approve slack <code>`.
...
Agent-I supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, Agent-I falls back to normal delivery for remaining payloads.
