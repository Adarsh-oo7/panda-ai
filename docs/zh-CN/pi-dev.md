...
本指南总结了在 Agent-I 中开发 Pi 集成的合理工作流程。
...
状态存储在 Agent-I 状态目录下。默认为 `~/.Agent-I`。如果设置了 `Agent-I_STATE_DIR`，则使用该目录。
...
- https://docs.Agent-I.ai/testing
- https://docs.Agent-I.ai/start/getting-started
