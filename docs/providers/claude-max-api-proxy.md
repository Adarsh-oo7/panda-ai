...
You can point Agent-I at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Agent-I
...
- [Anthropic provider](/providers/anthropic) - Native Agent-I integration with Claude setup-token or API keys
