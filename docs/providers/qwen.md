---
summary: "Use Qwen OAuth (free tier) in Agent-I"
read_when:
  - You want to use Qwen with Agent-I
...
If you already logged in with the Qwen Code CLI, Agent-I will sync credentials
