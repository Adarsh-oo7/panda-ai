---
summary: "Use NVIDIA's OpenAI-compatible API in Agent-I"
read_when:
  - You want to use NVIDIA models in Agent-I
...
Agent-I onboard --auth-choice skip
Agent-I models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
