...
read_when:
  - You want to place an outbound voice call from Agent-I
...
Voice calls for Agent-I via a plugin. Supports outbound notifications and
...
- Use `Agent-I voicecall ...` or the `voice_call` tool
...
```bash
Agent-I plugins install ./extensions/voice-call
