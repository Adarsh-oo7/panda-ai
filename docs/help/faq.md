---
summary: "Frequently asked questions about Agent-I setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Agent-I?](#whats-the-recommended-way-to-install-and-set-up-Agent-I)
  ...
  - [I can't access docs.Agent-I.ai (SSL error). What now?](#i-cant-access-docsAgent-Iai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or Agent-I not recognized](#windows-install-says-git-not-found-or-Agent-I-not-recognized)
  ...
  - [How do I install Agent-I on Linux?](#how-do-i-install-Agent-I-on-linux)
  - [How do I install Agent-I on a VPS?](#how-do-i-install-Agent-I-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Agent-I to update itself?](#can-i-ask-Agent-I-to-update-itself)
  ...
  - [If I buy a Mac mini to run Agent-I, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-Agent-I-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Agent-I instances?](#can-multiple-people-use-one-whatsapp-number-with-different-Agent-I-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Agent-I on a dedicated machine?](#how-important-is-it-to-run-Agent-I-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Agent-I in a VM and what are the requirements](#can-i-run-Agent-I-in-a-vm-and-what-are-the-requirements)
- [What is Agent-I?](#what-is-Agent-I)
  - [What is Agent-I, in one paragraph?](#what-is-Agent-I-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Agent-I](#what-are-the-top-five-everyday-use-cases-for-Agent-I)
  - [Can Agent-I help with lead gen outreach ads and blogs for a SaaS](#can-Agent-I-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Agent-I run tasks on a schedule or continuously in the background?](#can-Agent-I-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Agent-I saved locally?](#is-all-data-used-with-Agent-I-saved-locally)
  - [Where does Agent-I store its data?](#where-does-Agent-I-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Agent-I?](#how-do-i-completely-uninstall-Agent-I)
...
- [Config basics](#config-basics)
  ...
  - [Can the Agent-I browser run headless?](#can-the-Agent-I-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Agent-I instances talk to each other (local + VPS)?](#can-two-Agent-I-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Agent-I load environment variables?](#how-does-Agent-I-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Agent-I instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-Agent-I-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Agent-I but keep it installed?](#how-do-i-completely-reset-Agent-I-but-keep-it-installed)
  ...
  - [Why doesn't Agent-I reply in a group?](#why-doesnt-Agent-I-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Agent-I, Flawd, and Krill use for models?](#what-do-Agent-I-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `Agent-I gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-Agent-I-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `Agent-I gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-Agent-I-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Agent-I in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-Agent-I-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Agent-I?](#i-closed-my-terminal-on-windows-how-do-i-restart-Agent-I)
  ...
  - [ELI5: `Agent-I gateway restart` vs `Agent-I gateway`](#eli5-Agent-I-gateway-restart-vs-Agent-I-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Agent-I to inbound DMs?](#is-it-safe-to-expose-Agent-I-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/Agent-I/Agent-I-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   Agent-I health --json
   Agent-I health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://Agent-I.ai/install.sh | bash -s -- --install-method git
```

This installs Agent-I **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/Agent-I/Agent-I/issues](https://github.com/Agent-I/Agent-I/issues)
[https://github.com/Agent-I/Agent-I/pulls](https://github.com/Agent-I/Agent-I/pulls)

Start with these commands (share outputs when asking for help):

```bash
Agent-I status
Agent-I models status
Agent-I doctor
```

What they do:

- `Agent-I status`: quick snapshot of gateway/agent health + basic config.
- `Agent-I models status`: checks provider auth + model availability.
- `Agent-I doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `Agent-I status --all`, `Agent-I logs --follow`,
`Agent-I gateway status`, `Agent-I health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Agent-I
...
```bash
git clone https://github.com/Agent-I/Agent-I.git
cd Agent-I
pnpm install
pnpm build
...
If you don't have a global install yet, run it via `pnpm Agent-I onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `Agent-I_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `Agent-I config get gateway.auth.token` (or generate one: `Agent-I doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `Agent-I gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `Agent-I gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install Agent-I on the new machine.
2. Copy `$Agent-I_STATE_DIR` (default: `~/.Agent-I`) from the old machine.
3. Copy your workspace (default: `~/.Agent-I/workspace`).
4. Run `Agent-I doctor` and restart the Gateway service.
...
under `~/.Agent-I/` (for example `~/.Agent-I/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-Agent-I-store-its-data),
...
[https://github.com/Agent-I/Agent-I/blob/main/CHANGELOG.md](https://github.com/Agent-I/Agent-I/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I can't access docs.Agent-I.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.Agent-I.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.Agent-I.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsAgent-Iai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/Agent-I/Agent-I/tree/main/docs](https://github.com/Agent-I/Agent-I/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://Agent-I.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://Agent-I.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://Agent-I.ai/install.ps1](https://Agent-I.ai/install.ps1)
...
```bash
curl -fsSL https://Agent-I.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://Agent-I.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://Agent-I.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://Agent-I.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or Agent-I not recognized
...
**2) Agent-I is not recognized after install**
...
If you still reproduce this on latest Agent-I, track/report it in:

- [Issue #30640](https://github.com/Agent-I/Agent-I/issues/30640)
...
### How do I install Agent-I on Linux
...
### How do I install Agent-I on a VPS
...
### Can I ask Agent-I to update itself
...
```bash
Agent-I update
Agent-I update status
Agent-I update --channel stable|beta|dev
Agent-I update --tag <dist-tag|version>
Agent-I update --no-restart
```

If you must automate from an agent:

```bash
Agent-I update --yes --no-restart
Agent-I gateway restart
```
...
`Agent-I onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Agent-I with **API keys** (Anthropic/OpenAI/others) or with
...
OpenAI Codex OAuth is explicitly supported for external tools like Agent-I.
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `Agent-I models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `Agent-I models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. Agent-I no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Agent-I can keep replying while a provider is rate-limited.
...
Agent-I supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Agent-I fully supports **OpenAI Code (Codex) subscription OAuth**.
OpenAI explicitly allows subscription OAuth usage in external tools/workflows
like Agent-I. The onboarding wizard can run the OAuth flow for you.

See [OAuth](/concepts/oauth), [Model providers](/concepts/model-providers), and [Wizard](/start/wizard).

### How do I set up Gemini CLI OAuth

Gemini CLI uses a **plugin auth flow**, not a client id or secret in `Agent-I.json`.

Steps:

1. Enable the plugin: `Agent-I plugins enable google-gemini-cli-auth`
2. Login: `Agent-I models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Agent-I needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.5 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Agent-I runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run Agent-I can I connect it to my MacBook Pro
...
- Use `Agent-I nodes status` / `Agent-I nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but Agent-I authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `Agent-I logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Agent-I instances
...
If you run Agent-I via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the Agent-I code install. Your state
(`~/.Agent-I`) and workspace (`~/.Agent-I/workspace`) stay untouched.
...
**Agent-I-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Agent-I on a dedicated machine
...
Agent-I is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Agent-I in a VM and what are the requirements
...
### What is Agent-I in one paragraph

Agent-I is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

Agent-I is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Agent-I
...
### Can Agent-I help with lead gen outreach ads and blogs for a SaaS
...
Agent-I draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Agent-I is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Agent-I when you
...
Showcase: [https://Agent-I.ai/showcase](https://Agent-I.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.Agent-I/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.Agent-I/Agent-I.json`). Precedence is `<workspace>/skills` > `~/.Agent-I/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.Agent-I/Agent-I.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.Agent-I/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which Agent-I treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `Agent-I_SKIP_CRON` is not set.
...
```bash
Agent-I cron run <jobId> --force
Agent-I cron runs --id <jobId> --limit 50
```
...
### Can Agent-I run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.Agent-I.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-Agent-I-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Agent-I can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.Agent-I/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "Agent-I": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured Agent-I workspace); Agent-I treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.Agent-I/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
```bash
Agent-I browser extension install
Agent-I browser extension path
```
...
- Persist `/home/node` with `Agent-I_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `Agent-I_DOCKER_APT_PACKAGES`.
...
Agent-I memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Agent-I also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, Agent-I auto-selects a provider when it
...
configured and present, Agent-I
...
### Is all data used with Agent-I saved locally

No - **Agent-I's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.Agent-I` + your workspace directory).
...
### Where does Agent-I store its data
...
| `$Agent-I_STATE_DIR/agents/<agentId>/agent/auth.json`          | Legacy compatibility file (static `api_key` entries scrubbed)      |
| `$Agent-I_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)            |
| `$Agent-I_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                              |
| `$Agent-I_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                           |
| `$Agent-I_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                       |

Legacy single-agent path: `~/.Agent-I/agent/*` (migrated by `Agent-I doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.Agent-I/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.Agent-I`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.Agent-I`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.Agent-I/skills`).

Default workspace is `~/.Agent-I/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.Agent-I/workspace" } },
}
```
...
Do **not** commit anything under `~/.Agent-I` (credentials, sessions, tokens, or encrypted secrets payloads).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Agent-I
...
`workspace` to the repo root. The Agent-I repo is just source code; keep the
...
Agent-I reads an optional **JSON5** config from `$Agent-I_CONFIG_PATH` (default: `~/.Agent-I/Agent-I.json`):

```
$Agent-I_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.Agent-I/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `Agent-I_GATEWAY_TOKEN`).
...
Agent-I enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `Agent-I doctor --generate-gateway-token`.
...
- `default`: uses `All your chats, one Agent-I.` every time.
- `random`: rotating funny/seasonal taglines (default behavior).
- If you want no banner at all, set env `Agent-I_HIDE_BANNER=1`.

### How do I enable web search and web fetch

`web_fetch` works without an API key. `web_search` requires a Brave Search API
key. **Recommended:** run `Agent-I configure --section web` to store it in
...
- Daemons read env vars from `~/.Agent-I/.env` (or the service environment).
...
### Can the Agent-I browser run headless
...
5. Approve the node on the Gateway:
   ...
   ```bash
   Agent-I devices list
   Agent-I devices approve <requestId>
   ```
...
- Gateway is running: `Agent-I gateway status`
- Gateway health: `Agent-I status`
- Channel health: `Agent-I channels status`
...
### Can two Agent-I instances talk to each other local VPS
...
`Agent-I agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
Agent-I agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.Agent-I/Agent-I.json`).
- If you have no backup, re-run `Agent-I doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `Agent-I config set` for small changes.
- Use `Agent-I configure` for interactive edits.
...
```bash
Agent-I gateway --tailscale serve
```
...
### How does Agent-I load environment variables

Agent-I reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.Agent-I/.env` (aka `$Agent-I_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.Agent-I/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`Agent-I_LOAD_SHELL_ENV=1`, `Agent-I_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`Agent-I models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means Agent-I won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.Agent-I/.env`:
...
### Is there a way to make a team of Agent-I instances one CEO and many agents
...
### How do I completely reset Agent-I but keep it installed
...
```bash
Agent-I reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `Agent-I_PROFILE`), reset each state dir (defaults are `~/.Agent-I-<profile>`).
- Dev reset: `Agent-I gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Agent-I skips the heartbeat run to save API calls.
...
No. Agent-I runs on **your own account**, so if you're in the group, Agent-I can see it.
...
```bash
Agent-I directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't Agent-I reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.Agent-I/agents/<agentId>/sessions/`.
...
- Use `Agent-I doctor` to spot stray workspaces and profile mismatches.
...
Agent-I's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, Agent-I currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `Agent-I models set ...` (updates just model config)
- `Agent-I configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.Agent-I/Agent-I.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `Agent-I doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do Agent-I, Flawd, and Krill use for models

- These deployments can differ and may change over time; there is no fixed provider recommendation.
- Check the current runtime setting on each gateway with `Agent-I models status`.
...
Yes. Agent-I ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.Agent-I/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `Agent-I agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Agent-I can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.Agent-I/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.Agent-I/agent/*` (migrated by `Agent-I doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.Agent-I/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `Agent-I models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `Agent-I models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `Agent-I models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.Agent-I/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    Agent-I models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Agent-I will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: Agent-I now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Agent-I uses provider-prefixed IDs like:
...
Agent-I may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `Agent-I models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
Agent-I models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
Agent-I models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
Agent-I models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
Agent-I models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

Agent-I supports both:
...
```
--port > Agent-I_GATEWAY_PORT > gateway.port > default 18789
```

### Why does Agent-I gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `Agent-I gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does Agent-I gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `Agent-I_STATE_DIR` mismatch).

Fix:

```bash
Agent-I gateway install --force
```
...
Agent-I enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `Agent-I gateway --port <port>`.

### How do I run Agent-I in remote mode client connects to a Gateway elsewhere
...
- `Agent-I gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `Agent-I.control.settings.v1`.

Fix:

- Fastest: `Agent-I dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `Agent-I doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `Agent-I_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `Agent-I status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `Agent-I_CONFIG_PATH` (per-instance config)
- `Agent-I_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `Agent-I --profile <name> …` per instance (auto-creates `~/.Agent-I-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `Agent-I --profile <name> gateway install`.

Profiles also suffix service names (`ai.Agent-I.<profile>`; legacy `com.Agent-I.*`, `Agent-I-gateway-<profile>.service`, `Agent-I Gateway (<profile>)`).
...
```
Agent-I tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/Agent-I/Agent-I-YYYY-MM-DD.log
```
...
- macOS: `$Agent-I_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.Agent-I/logs/...`; profiles use `~/.Agent-I-<profile>/logs/...`)
- Linux: `journalctl --user -u Agent-I-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Agent-I Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `Agent-I gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Agent-I
...
1. Is the Gateway running? `Agent-I gateway status`
2. Is the Gateway healthy? `Agent-I status`
3. Does the UI have the right token? `Agent-I dashboard`
...
```bash
Agent-I channels status
Agent-I channels logs --channel telegram
```
...
### ELI5 Agent-I gateway restart vs Agent-I gateway

- `Agent-I gateway restart`: restarts the **background service** (launchd/systemd).
- `Agent-I gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `Agent-I gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Agent-I assistant setup](/start/Agent-I) and [Agent send](/tools/agent-send).

CLI sending:

```bash
Agent-I message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Agent-I to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `Agent-I pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `Agent-I pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `Agent-I doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Agent-I only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
Agent-I pairing approve whatsapp <code>
```

List pending requests:

```bash
Agent-I pairing list whatsapp
```
...
Agent-I blocks **cross-provider** messaging by default. If a tool call is bound
