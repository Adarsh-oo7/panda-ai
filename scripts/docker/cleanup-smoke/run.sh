...
export OPENCLAW_STATE_DIR="/tmp/Agent-I-test"
...
pnpm Agent-I reset --scope config+creds+sessions --yes --non-interactive
...
pnpm Agent-I uninstall --state --yes --non-interactive
