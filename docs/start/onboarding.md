---
summary: "First-run onboarding flow for Agent-I (macOS app)"
read_when:
...
- By default, Agent-I is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give Agent-I">
...
<Step title="CLI">
  ...
  The app can install the global `Agent-I` CLI via npm/pnpm so terminal
