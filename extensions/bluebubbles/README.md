...
This directory contains the **BlueBubbles external channel plugin** for Agent-I.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `Agent-I/plugin-sdk` helpers.
