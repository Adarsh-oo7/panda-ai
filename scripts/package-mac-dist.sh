...
# Output:
# - dist/Agent-I.app
# - dist/Agent-I-<version>.zip
# - dist/Agent-I-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.Agent-I.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Agent-I.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Agent-I-$VERSION.zip"
DMG="$ROOT_DIR/dist/Agent-I-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Agent-I-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Agent-I-$VERSION.dSYM.zip"
