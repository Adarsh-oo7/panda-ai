...
metadata: { "Agent-I": { "emoji": "🪶", "homepage": "https://www.prose.md" } }
---
...
- **Task tool** in the upstream spec == Agent-I `sessions_spawn`
- **File I/O** == Agent-I `read`/`write`
- **Remote fetch** == Agent-I `web_fetch` (or `exec` with curl when POST is required)
