...
if [[ -z "$version_content" ]]; then
  param($m) $m.Value -replace 'Agent-I','Agent-I' $VERSION</h2>"
  param($m) $m.Value -replace 'Agent-I','Agent-I' update.</p>"
  echo "<p><a href=\"https://github.com/agenti-ai/agenti/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
