...
Nostr DM channel plugin for Agent-I using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Agent-I. It enables your bot to:
...
# Configure Agent-I to use local relay
