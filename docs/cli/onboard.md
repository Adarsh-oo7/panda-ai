---
summary: "CLI reference for `Agent-I onboard` (interactive onboarding wizard)"
read_when:
...
```bash
Agent-I onboard
Agent-I onboard --flow quickstart
Agent-I onboard --flow manual
Agent-I onboard --mode remote --remote-url wss://gateway-host:18789
```

For plaintext private-network `ws://` targets (trusted networks only), set
`Agent-I_ALLOW_INSECURE_PRIVATE_WS=1` in the onboarding process environment.
...
- Fastest first chat: `Agent-I dashboard` (Control UI, no channel setup).
