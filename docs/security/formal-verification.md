...
summary: Machine-checked security models for Agent-I’s highest-risk paths.
read_when:
...
This page tracks Agent-I’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Agent-I enforces its
...
**What this is not (yet):** a proof that “Agent-I is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/Agent-I-formal-models](https://github.com/vignesh07/Agent-I-formal-models).
...
```bash
git clone https://github.com/vignesh07/Agent-I-formal-models
cd Agent-I-formal-models
