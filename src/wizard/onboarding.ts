...
async function requireRiskAcknowledgement(params: {
  ...
  await params.prompter.note(
    [
      ...
      "",
      "Agent-I (Panda AI) is a hobby project and still in beta. Expect sharp edges.",
      "By default, Agent-I (Panda AI) is a personal agent: one trusted operator boundary.",
      "This bot can read files and run actions if tools are enabled.",
      "A bad prompt can trick it into doing unsafe things.",
      "",
      "Agent-I (Panda AI) is not a hostile multi-tenant boundary by default.",
      "If multiple users can message one tool-enabled agent, they share that delegated tool authority.",
      "",
      "If you’re not comfortable with security hardening and access control, don’t run Agent-I (Panda AI).",
...
export async function runOnboardingWizard(
  ...
  await prompter.intro("Agent-I (Panda AI) onboarding");
