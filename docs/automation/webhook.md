...
read_when:
  ...
  - Wiring external systems into Agent-I
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Agent-I config directory (typically `~/.Agent-I/hooks/transforms`).
...
- `Agent-I webhooks gmail setup` writes `hooks.gmail` config for `Agent-I webhooks gmail run`.
