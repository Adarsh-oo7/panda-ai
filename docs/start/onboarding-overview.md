---
summary: "Overview of Agent-I onboarding options and flows"
read_when:
...
Agent-I supports multiple onboarding paths depending on where the Gateway runs
...
- [`Agent-I onboard` command](/cli/onboard)

## macOS app onboarding

Use the Agent-I app when you want a fully guided setup on macOS. Docs:
