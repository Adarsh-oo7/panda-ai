...
Agent-I treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.Agent-I/settings/voicewake.json`

Shape:

```json
{ "triggers": ["Agent-I", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
