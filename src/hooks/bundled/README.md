...
This directory contains hooks that ship with Agent-I. These hooks are automatically discovered and can be enabled/disabled via CLI or configuration.
...
Hooks can be configured in `~/.Agent-I/Agent-I.json`:
...
2. Restart gateway: `pkill -9 -f 'Agent-I.*gateway' && pnpm Agent-I gateway`
3. Enable the hook: `Agent-I hooks enable my-hook`
4. Trigger the event (e.g., send `/new` command)
5. Check gateway logs for hook execution

## Documentation

Full documentation: https://docs.Agent-I.ai/automation/hooks
