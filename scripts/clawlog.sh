...
show_usage() {
    cat << EOF
clawlog - Agent-I Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Agent-I logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Agent-I logs flow through the macOS unified log (subsystem: ai.Agent-I).
