---
summary: "VPS hosting hub for Agent-I (Oracle/Fly/Hetzner/GCP/exe.dev)"
read_when:
...
- `Agent-I_NO_RESPAWN=1` avoids extra startup overhead from a self-respawn path.
...
- Add service env for stable startup path:
  - `Agent-I_NO_RESPAWN=1`
  - `NODE_COMPILE_CACHE=/var/tmp/Agent-I-compile-cache`
