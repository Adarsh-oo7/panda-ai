...
homepage: https://docs.Agent-I.ai/automation/hooks#command-logger
metadata:
  {
    "Agent-I":
      {
...
2. **Appends to log file** - Writes a JSON line to `~/.Agent-I/logs/commands.log`
...
1. **Manual rotation**:
   ...
   ```bash
   mv ~/.Agent-I/logs/commands.log ~/.Agent-I/logs/commands.log.old
   ```

2. **Use logrotate** (Linux):
   Create `/etc/logrotate.d/Agent-I`:
   ```
   /home/username/.Agent-I/logs/commands.log {
       weekly
       rotate 4
       compress
       missingok
