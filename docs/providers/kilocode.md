---
summary: "Use Kilo Gateway's unified API to access many models in Agent-I"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in Agent-I
---
...
```bash
Agent-I onboard --kilocode-api-key <key>
```
