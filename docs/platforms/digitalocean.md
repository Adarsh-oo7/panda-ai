---
summary: "Agent-I on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up Agent-I on DigitalOcean
  - Looking for cheap VPS hosting for Agent-I
title: "DigitalOcean"
---

# Agent-I on DigitalOcean

## Goal

Run a persistent Agent-I Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
# Check service
systemctl --user status Agent-I-gateway.service

# View logs
journalctl --user -u Agent-I-gateway.service -f
```
...
```bash
Agent-I channels login whatsapp
# Scan QR code
```
...
- `~/.Agent-I/workspace/` — workspace (SOUL.md, memory, etc.)
...
journalctl -u Agent-I --no-pager -n 50
```
